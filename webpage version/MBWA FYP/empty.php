...
<html lang="en">
    ...
    <body>
        <div class="container">
            ...
            <p align="center">Click Image back to main page</p>
            <div class="row">
                <div class="col-sm-12">
                    <a href="main_page.php"><img src="image/construction.jpg" alt="banner" id="banner" class="img-rounded" height="800" width="1080" /></a>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
